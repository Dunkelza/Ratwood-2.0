/datum/job/roguetown/dtshophand
	...
	tutorial = "You work the largest store in Al-Ashur by grace of the Merchant who has shackled you to this drudgery. The work of stocking shelves and taking inventory for your employer is mind-numbing and repetitive--but at least you have a roof over your head and comfortable surroundings. With time, perhaps you will one day be more than a glorified servant."

	outfit = /datum/outfit/job/roguetown/dtshophand
...
/datum/advclass/dtshophand
	name = "Shophand"
	tutorial = "You work the largest store in the region by grace of the Merchant who has shackled you to this drudgery. \
	...
	outfit = /datum/outfit/job/roguetown/dtshophand/basic
...
/datum/outfit/job/roguetown/dtshophand/basic/pre_equip(mob/living/carbon/human/H)
	..()
